                                                            ...
                                                            tableColumnsMap[map.targetTable]
                                                                ...
                                                                .map(col => (
                                                                    <option key={col.name} value={col.name}>
                                                                        {col.name}
                                                                        {col.isNullable === false && !col.isAutoGenerated && !col.isGenerated && !col.isIdentity && !col.columnDefault ? ' *' : ''}
                                                                        {col.isForeignKey ? ' (FK)' : ''}
                                                                    </option>
                                                                ))
                                                        }
                                            ...
                                            <div className="flex flex-col gap-2 items-start">
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    ...
                                                    {map.targetTable && tableColumnsMap[map.targetTable] && (() => {
                                                        ...
                                                        return (
                                                            <>
                                                                {targetCol.isNullable === false && !targetCol.isAutoGenerated && !targetCol.isGenerated && !targetCol.isIdentity && !targetCol.columnDefault && (
